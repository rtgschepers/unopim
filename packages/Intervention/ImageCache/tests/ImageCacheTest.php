...
class ImageCacheTest extends TestCase
{
    ...
    public function test_constructor_with_injection()
    {
    ...
    public function test_magic_method_calls()
    {
        $img = new ImageCache;
    ...
    public function test_checksum_with_closure()
    {
    ...
    public function test_checksum_with_property()
    {
        // checksum of test image resized to 300x200
        $sum = '9b3c716836cb438c4619eb0452740019';
        $img = new ImageCache;
    ...
    public function test_get_image_from_cache()
    {
        $lifetime = 12;
    ...
    public function test_get_image_from_cache_as_object()
    {
        $lifetime = 12;
        $checksum = '2fff960136929390427f9409eac34c42';
        $imagedata = 'mocked image data';
    ...
    public function test_get_image_not_from_cache()
    {
        $lifetime = 12;
        $checksum = '2fff960136929390427f9409eac34c42';
        $imagedata = 'mocked image data';
    ...
    public function test_get_image_not_from_cache_as_object()
    {
        $lifetime = 12;
        $checksum = '2fff960136929390427f9409eac34c42';
        $imagedata = 'mocked image data';
    ...
    public function test_original_file_changed()
    {
    ...
    public function test_binary_input()
    {
